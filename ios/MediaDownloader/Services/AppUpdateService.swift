...
enum AppUpdateError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .noIOSRelease:
            return "暂未找到 iOS 版本。发布时请使用 ios-v1.0.0 这样的标签。"
        }
    }
}
...
enum AppUpdateService {
    ...
    static func checkForUpdates() async throws -> AppUpdateResult {
        let endpoints = [
            "https://api.github.com/repos/Xynrin/tiktok-douyin-dl/releases?per_page=30",
            "https://gh-proxy.org/https://api.github.com/repos/Xynrin/tiktok-douyin-dl/releases?per_page=30"
