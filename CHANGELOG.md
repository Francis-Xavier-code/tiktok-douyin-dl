...
- **[CLI]** 更新提示显示本端更新日志：打包版 `media-downloader` 启动时静默检查新版本并打印本端更新日志（不自动替换）；Agent skill 支持 macOS 安装，并修复安装时下载不存在的裸二进制资产的错误。
...
[2.0.0]: https://github.com/Francis-Xavier-code/tiktok-douyin-dl/releases/tag/v2.0.0
[Unreleased]: https://github.com/Francis-Xavier-code/tiktok-douyin-dl/compare/v2.0.0...HEAD
