...
OutputBaseFilename=MediaDownloader-Windows-x64-Setup-{#AppVersion}
Compression=lzma2
...
LicenseFile={#RepoRoot}\Disclaimer.txt
...
[Files]
Source: "{#RepoRoot}\dist\MediaDownloader_GUI\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "{#RepoRoot}\ms-playwright\*"; DestDir: "{%USERPROFILE}\.cache\ms-playwright"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "{#RepoRoot}\Disclaimer.txt"; DestDir: "{app}"; Flags: ignoreversion
